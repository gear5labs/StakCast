pub mod Errors {
    ...
    pub const ERR_RESOLVABLE_BY_ASSIGNED_VALIDATORS: felt252 = 'Only assigned validator can resolve';
    ...
    pub const ERR_CANCELLATION_ONLY_BY_MARKET_CREATOR: felt252 = 'Only market creator can cancel';
