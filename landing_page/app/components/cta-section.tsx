  ...
  return (
    <section className="container mx-auto px-4 py-20">
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-emerald-600 to-blue-600 dark:from-emerald-900 dark:to-blue-900 p-8 md:p-12 animate-on-scroll">
        ...
        <div className="relative z-10 flex flex-col items-center text-center md:flex-row md:text-left md:items-center">
          <div className="md:w-2/3">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              <Button
                size="lg"
                className="bg-white text-slate-900 hover:bg-white/90 transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 min-w-fit"
                asChild
              >
                <Link
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-white/20 text-white hover:bg-white/10 bg-transparent transition-all duration-300 hover:shadow-md hover:-translate-y-0.5 min-w-fit group"
                asChild
              >
                <Link
                  href="#"
          ...
          <div className="mt-8 md:mt-0 md:w-1/3 flex justify-center">
            <div className="relative h-40 w-40 md:h-48 md:w-48 animate-float-slow">
