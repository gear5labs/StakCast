  ...
  return (
    <>
     ...
     <SEO
          ...
          />
      <section id="features" className="container mx-auto px-4 py-20" role="region" aria-labelledby="features-title">
        <h2 id="features-title" className="sr-only">{seoData.features.title}</h2>
        <div className="mb-16 text-center animate-on-scroll">
          <h2 className="mb-4 text-3xl font-bold md:text-4xl">
            Why Choose StakCast
          </h2>
          <p className="mx-auto max-w-2xl text-slate-600 dark:text-slate-300">
            Our platform will offer unique advantages for prediction market participants
          </p>
        </div>
